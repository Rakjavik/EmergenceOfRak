...
namespace rak.creatures
{
    public abstract class MiscVariables
    {
        public enum AgentMiscVariables
        {
            ...
            Part_Flight_Close_To_Target_Brake_Percent,
            Part_Flight_Close_To_Target_Max_Vel_Mag_Before_Brake,
            ...
            Agent_Right_Rotation_Amount,
            MoveVar_Start_Up_Time_In_Minutes,
            Agent_Correct_Rotation_If_Diff_Less_Than,
            Agent_Is_Stuck_If_Moved_Less_Than_In_Five_Secs,
        ...
        public static Dictionary<AgentMiscVariables, float> GetAgentMiscVariables(BASE_SPECIES species)
        {
            ...
            if (species == BASE_SPECIES.Gnat)
            {
                ...
                miscVariables.Add(AgentMiscVariables.Part_Flight_Close_To_Target_Brake_Percent, 50);
                miscVariables.Add(AgentMiscVariables.Part_Flight_Close_To_Target_Max_Vel_Mag_Before_Brake, 1);
                ...
                miscVariables.Add(AgentMiscVariables.Agent_Right_Rotation_Amount, .5f);
                miscVariables.Add(AgentMiscVariables.MoveVar_Start_Up_Time_In_Minutes, .1f);
                miscVariables.Add(AgentMiscVariables.Agent_Correct_Rotation_If_Diff_Less_Than, .25f);
                miscVariables.Add(AgentMiscVariables.Agent_Is_Stuck_If_Moved_Less_Than_In_Five_Secs,6);
            }
