...
namespace rak.creatures
{
    public class CreatureAgent
    {
        ...
        private float[] distanceMoved = new float[5];
        private int distanceMovedIndex = 0;
        private float updateDistanceMovedEvery = .1f;
        private float distanceLastUpdated = 0;
        ...
        public void Update()
        {
            ...
            distanceLastUpdated += Time.deltaTime;
            ...
            if(Time.time > .01f)
            {
                ...
                if(distanceLastUpdated >= updateDistanceMovedEvery)
                {
	                distanceMoved[distanceMovedIndex] = DistanceMovedLastUpdate;
	                if(distanceMovedIndex+1 == 5)
	                	distanceMovedIndex = 0;
	                else
	                	distanceMovedIndex++;
	                distanceLastUpdated = 0;
                }
            }
        ...
        {
        	float distance = 0;
        	for(int count = 0; count < distanceMoved.Length; count++)
        	{
        		distance += distanceMoved[count];
        	}
        	return distance;
        }
